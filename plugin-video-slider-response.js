var jsPsychVideoSliderResponse = (function (jspsych) { 'use strict';
  ...
  class VideoSliderResponsePlugin {
      ...
      `);
        ...
        //
          ...
          var video_html = trial.prompt + "</div>";
          video_html += '<video id="jspsych-video-slider-response-stimulus-video"';
          if (trial.width) {
          ...
          display_element
              ...
              var hue = (1 - percentage) * 120; // Blue to red gradient
              ...
              var currentValue = display_element.querySelector("#jspsych-video-slider-response-response").valueAsNumber
              response.rt.push(Math.round(endTime - startTime));
              response.response.push(currentValue);
